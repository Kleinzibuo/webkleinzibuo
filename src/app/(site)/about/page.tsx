          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-[#E82D86]">
                Built for South African Preschools
              </span>
            </h1>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Based in Durban with strong roots in Pinetown, Klein Zibuo
                understands the unique challenges facing South African
                preschools. We've seen how administrative burdens can take time
                away from what matters most — the children.
              </p>

              <p className="text-lg text-gray-600 leading-relaxed">
                We are more than just a tech company; we are your partner in
                creating a connected, informed, and thriving preschool
                community. Our focus is on keeping parents informed at all
                times, turning everyday moments into shared experiences.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              To create technology that simplifies preschool management while
              strengthening the connection between schools and families.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  "Klein Zibuo" reflects our dedication to the little ones
                  (Klein) and our toolkit (Zibuo) of solutions designed for
            ...
            {[
              {
                ...
                text: "Built for SA preschools",
              },
              {
                icon: Target,
                title: "Purpose-Built",
                text: "Designed for your school",
              },
              {
                icon: CheckCircle,
                title: "Proven Results",
                text: "Trusted by top preschools",
              },
              {
                icon: Zap,
              ...
              >
                <div
                  className="w-16 h-16 bg-gradient-to-br from-[#E82D86] to-[#F047A0] 
            ...
            {[
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className="w-12 h-12 bg-gradient-to-br from-[#E82D86] to-[#F047A0] 
