    ...
    <div className="pt-20">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <div className="inline-block px-4 py-2 bg-[#FFF4F0] rounded-full border border-[#FF6B35]/20">
              <span className="text-[#FF6B35]">✨ Complete Platform Features</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1762265591492-1454ae17f31a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzY2hvb2wlMjBhZG1pbmlzdHJhdG9yJTIwb2ZmaWNlfGVufDF8fHx8MTc2MjM3NTM0N3ww&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            >
              <div>
                <div className="inline-block px-3 py-1 bg-[#FF6B35]/10 rounded-full mb-4">
                  <span className="text-[#FF6B35]">For School Leaders</span>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#FF6B35] to-[#FF8C5F] rounded-xl flex items-center justify-center shadow-md">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#4A90E2] to-[#6BA8E8] rounded-xl flex items-center justify-center shadow-md">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#7DCE82] to-[#9DD9A1] rounded-xl flex items-center justify-center shadow-md">
              ...
              <button className="text-[#FF6B35] hover:text-[#FF5520] transition-colors inline-flex items-center gap-2 group">
                Learn More
      ...
      <section className="py-24 bg-[#F8F9FA]">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div>
                <div className="inline-block px-3 py-1 bg-[#4A90E2]/10 rounded-full mb-4">
                  <span className="text-[#4A90E2]">For Teachers</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Your Day, Simplified
                </h2>
              ...
              <button className="text-[#4A90E2] hover:text-[#3A7BC2] transition-colors inline-flex items-center gap-2 group">
                Learn More
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </button>
            </motion.div>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl max-w-md mx-auto">
                <img src={mobileAppReport} alt="Teacher Dashboard" className="w-full h-auto" />
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1740493430383-a0bfff9550a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVzY2hvb2wlMjBwYXJlbnRzJTIwY29tbXVuaXR5fGVufDF8fHx8MTc2MjQ1NjQyNnww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Parents using mobile app"
                  className="w-full h-auto"
                />
            ...
            >
              <div>
                <div className="inline-block px-3 py-1 bg-[#7DCE82]/10 rounded-full mb-4">
                  <span className="text-[#7DCE82]">For Parents</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ...
              <button className="text-[#7DCE82] hover:text-[#6DBE72] transition-colors inline-flex items-center gap-2 group">
                Learn More
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </button>
            </motion.div>
      ...
      <section className="py-24 bg-gradient-to-br from-[#F8F9FA] to-white">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <div>
              <div className="w-20 h-20 bg-gradient-to-br from-[#4A90E2] to-[#6BA8E8] rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
