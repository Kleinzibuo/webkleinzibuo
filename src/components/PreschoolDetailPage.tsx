...
const preschoolsData: Record<number, Preschool> = {
  1: {
    ...
    location: "9 Roselle Road, Manors, Pinetown 3610",
    area: "Pinetown",
    phone: "084 400 1980",
    email: "admin@rosellepreprimary.co.za",
    website: "www.rosellepreprimary.co.za",
    ...
    gallery: [
      ...
      "https://www.rosellepreprimary.co.za/images/gallery/facilities/02.jpg",
      "https://www.rosellepreprimary.co.za/images/gallery/photography/11.jpg",
      "https://www.rosellepreprimary.co.za/images/gallery/photography/12.jpg",
    ],
    curriculum: [
